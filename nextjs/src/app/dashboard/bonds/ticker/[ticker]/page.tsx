    ...
    <main className="min-h-screen bg-[#020617] text-slate-300 p-4 sm:p-6 lg:p-12 space-y-8 selection:bg-indigo-500/30">
      ...
      <header className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
          ...
          {/* 3. CREDIT SCOREBOARD - Fixed Desktop Layout */}
          <div className="w-full lg:w-fit lg:min-w-[320px] grid grid-cols-2 lg:flex lg:items-stretch bg-[#0a0f1d] border border-slate-800 rounded-2xl overflow-hidden shadow-2xl">
            {/* Current Rating */}
            <div className="px-4 py-4 sm:px-8 sm:py-3 flex flex-col justify-center border-r border-slate-800 lg:flex-1">
            ...
            {/* Implied Rating */}
            <div className="px-4 py-4 sm:px-8 sm:py-3 flex flex-col justify-center bg-indigo-500/5 lg:flex-1">
              <div className="flex items-center gap-1.5 mb-1">
                <Activity className="w-3 h-3 text-emerald-500 shrink-0" />
                <p className="text-[8px] sm:text-[9px] font-black text-indigo-400 uppercase tracking-widest whitespace-nowrap">
                  Implied
                </p>
              </div>
              <p className="text-2xl sm:text-3xl font-black text-emerald-400 tracking-tighter leading-none">
                {r.implied_rating || "NR"}
              </p>
            </div>
          </div>
