        ...
        "CONFIG": {
            "hosts": [
                (
                    ...
                    int(os.environ.get("REDIS_DB_STREAM", 1)),
                )
            ],
        },
    },
...
# Optional: include extra static folders if you have them
STATICFILES_DIRS = [
    BASE_DIR / "static",  # put your custom static files here
]


STATIC_ROOT = BASE_DIR / "staticfiles"  # Django will collect static files here

# Enable WhiteNoise storage for caching & compression
